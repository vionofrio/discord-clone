  ...
  return (
    <div className="grid-areas-layout grid h-screen grid-cols-layout grid-rows-layout">
      ...
      <div className="grid grid-cols-subgrid grid-rows-subgrid [grid-area:titleBarEnd/start/end/end]">
        <div className="relative grid grid-cols-subgrid grid-rows-subgrid [grid-area:titleBarEnd/start/end/channelsEnd] before:absolute before:inset-x-0 before:bottom-0 before:h-2 before:bg-background before:content-['']">
          <GuildList />
